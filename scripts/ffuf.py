...
parser.add_argument("-u", "--url", default= input("Enter target URL:"), help="Target URL with FUZZ keyword (default: http://example.com/FUZZ)")
parser.add_argument("-w", "--wordlist", default="/usr/share/wordlists/seclists/Discovery/Web-Content/common.txt", help="Custom wordlist file for ffuf")
